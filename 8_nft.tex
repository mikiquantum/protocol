...
\end{split}
\end{equation}
%TODO:equation 115 is outdated.Add revoke check and Recover
...
%TODO: Explain why this was done (to allow minting of more than one token per registry). Show that it is a map.
...
%TODO:  \subsubsection{Rule, Role and Read Action Proof}
